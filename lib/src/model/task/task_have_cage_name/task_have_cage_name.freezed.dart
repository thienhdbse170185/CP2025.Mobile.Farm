...
TaskHaveCageName _$TaskHaveCageNameFromJson(Map<String, dynamic> json) {
  return _TaskHaveCageName.fromJson(json);
}

/// @nodoc
mixin _$TaskHaveCageName {
  ...
  $TaskHaveCageNameCopyWith<TaskHaveCageName> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TaskHaveCageNameCopyWith<$Res> {
  factory $TaskHaveCageNameCopyWith(
          TaskHaveCageName value, $Res Function(TaskHaveCageName) then) =
      _$TaskHaveCageNameCopyWithImpl<$Res, TaskHaveCageName>;
  @useResult
  $Res call(
      {String id,
      String cageId,
...
/// @nodoc
class _$TaskHaveCageNameCopyWithImpl<$Res, $Val extends TaskHaveCageName>
    implements $TaskHaveCageNameCopyWith<$Res> {
  _$TaskHaveCageNameCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$TaskHaveCageNameImplCopyWith<$Res>
    implements $TaskHaveCageNameCopyWith<$Res> {
  factory _$$TaskHaveCageNameImplCopyWith(_$TaskHaveCageNameImpl value,
          $Res Function(_$TaskHaveCageNameImpl) then) =
      __$$TaskHaveCageNameImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$TaskHaveCageNameImplCopyWithImpl<$Res>
    extends _$TaskHaveCageNameCopyWithImpl<$Res, _$TaskHaveCageNameImpl>
    implements _$$TaskHaveCageNameImplCopyWith<$Res> {
  __$$TaskHaveCageNameImplCopyWithImpl(_$TaskHaveCageNameImpl _value,
      $Res Function(_$TaskHaveCageNameImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$TaskHaveCageNameImpl implements _TaskHaveCageName {
  const _$TaskHaveCageNameImpl(
      {required this.id,
  ...
  @override
  String toString() {
    return 'TaskHaveCageName(id: $id, cageId: $cageId, cageName: $cageName, taskName: $taskName, description: $description, status: $status, createdAt: $createdAt, priorityNum: $priorityNum, dueDate: $dueDate, session: $session, completedAt: $completedAt, assignedToUser: $assignedToUser, taskType: $taskType)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$TaskHaveCageNameImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$TaskHaveCageNameImplCopyWith<_$TaskHaveCageNameImpl> get copyWith =>
      __$$TaskHaveCageNameImplCopyWithImpl<_$TaskHaveCageNameImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$TaskHaveCageNameImplToJson(
      this,
    );
  }
}

abstract class _TaskHaveCageName implements TaskHaveCageName {
  const factory _TaskHaveCageName(
      ...
      required final TaskType taskType}) = _$TaskHaveCageNameImpl;
