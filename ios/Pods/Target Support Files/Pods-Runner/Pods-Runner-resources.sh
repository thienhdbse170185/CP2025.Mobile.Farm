...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/GoogleToolboxForMac/GoogleToolboxForMac_Privacy.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/GoogleToolboxForMac/GoogleToolboxForMac_Logger_Privacy.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/app_settings/app_settings_privacy.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/flutter_native_splash/flutter_native_splash_privacy.bundle"
