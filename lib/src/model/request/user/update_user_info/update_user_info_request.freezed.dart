...
class _$UpdateUserInfoRequestImpl implements _UpdateUserInfoRequest {
  ...
  @override
  String toString() {
    return 'UpdateUserInfoRequest(fullName: $fullName, email: $email, phoneNumber: $phoneNumber, address: $address, imageUrl: $imageUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, fullName, email, phoneNumber, address, imageUrl);
...
abstract class _UpdateUserInfoRequest implements UpdateUserInfoRequest {
  factory _UpdateUserInfoRequest(
      ...
      required final String imageUrl}) = _$UpdateUserInfoRequestImpl;
